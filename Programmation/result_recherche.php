...
$chose = isset($_POST["choix"])? $_POST["choix"] : "";
$requete = isset($_POST["valeur"])? $_POST["valeur"] :"";
//Si la BDD existe
if ($db_found) {
//code MySQL. $sql est basé sur le choix de l’utilisateur
if (choix==1)
{
$sql = "SELECT Photo, Prenom_C, Nom_C, Mail_C, Telephone_C, Sport1, Sport2, Sport3 FROM coach WHERE Nom_C='$valeur'";
}
if(choix==3)
{
  $sql = "SELECT Photo, Prenom_C, Nom_C, Mail_C, Telephone_C, Sport1, Sport2, Sport3 FROM coach WHERE ((Sport1='$valeur')||(Sport2='$valeur')||(Sport3='$valeur'))";
}
if(choix==2)
{
  $sql ="SELECT Photo, Nom_S, Adresse_S, Email_S, Telephone_S FROM salle WHERE Nom_S='$valeur'";
}}
    ...
    <div class="col-md-5">
        ...
        <div class="col-md-7">
            <h2><?php echo $data['Nom_C'];?>, <?php echo $data['Prenom_C']?><br>
                ...
                Telephone: +33<?php echo $data['Telephone_C'];?><br>
...
if(choix==2)
{
  <div class="containers">
    ...
    <div class="col-md-5">
        ...
        <div class="col-md-7">
            <h2><?php echo $data['Nom_S'];?><br>
                Adresse: <?php echo $data['Adresse_s'];?><br>
                Telephone: +33<?php echo $data['Telephone_S'];?><br>
                E-Mail: <?php echo $data['Mail_S'];?></h2>
                <input type="button" onclick="window.location.href = 'https://www.w3docs.com';" value="Prendre un Rendez-Vous"/>
        </div>
    </div>
</div>
